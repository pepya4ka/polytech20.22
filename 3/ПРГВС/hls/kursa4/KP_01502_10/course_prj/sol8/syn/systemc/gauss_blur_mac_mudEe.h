...
// ==============================================================
#ifndef __gauss_blur_mac_mudEe__HH__
#define __gauss_blur_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gauss_blur_mac_mudEe) {
    ...
    SC_CTOR(gauss_blur_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
