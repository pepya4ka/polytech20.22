...
// ==============================================================
#ifndef __gauss_blur_mac_mufYi__HH__
#define __gauss_blur_mac_mufYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gauss_blur_mac_mufYi) {
    ...
    SC_CTOR(gauss_blur_mac_mufYi):  simcore_mac_0_U ("simcore_mac_0_U") {
