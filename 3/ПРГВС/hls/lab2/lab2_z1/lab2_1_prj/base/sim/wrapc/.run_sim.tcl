...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/sokrat/tools/Xilinx/Vivado/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sokrat/tools/Xilinx/Vivado/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sokrat/tools/Xilinx/Vivado/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sokrat/tools/Xilinx/Vivado/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "find_max.autotvin.dat"
	set constFileTvOut       "find_max.autotvout.dat"
	set constFileHdlTvIn     "find_max.autohdltvin.dat"
	set constFileHdlTvOut    "find_max.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
