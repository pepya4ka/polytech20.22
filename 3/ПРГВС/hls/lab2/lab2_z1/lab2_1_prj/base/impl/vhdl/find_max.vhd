...
architecture behav of find_max is 
    ...
    "find_max,hls_ip_2020_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.257000,HLS_SYN_LAT=386,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=85,HLS_SYN_LUT=144,HLS_VERSION=2020_1}";
    ...
    signal i_reg_107 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal icmp_ln6_fu_65_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal max_1_reg_117 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal select_ln7_fu_87_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    icmp_ln7_fu_82_p2 <= "1" when (signed(max_0_reg_44) < signed(max_1_reg_117)) else "0";
    select_ln7_fu_87_p3 <= 
        max_1_reg_117 when (icmp_ln7_fu_82_p2(0) = '1') else 
        max_0_reg_44;
