...
if {[file isfile find_max.autotvin.dat]} {
	file delete -force find_max.autotvin.dat
}

if {[file isfile find_max.autotvout.dat]} {
	file delete -force find_max.autotvout.dat
}
