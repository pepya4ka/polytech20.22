...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "foo_b.autotvin.dat"
	set constFileTvOut       "foo_b.autotvout.dat"
	set constFileHdlTvIn     "foo_b.autohdltvin.dat"
	set constFileHdlTvOut    "foo_b.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
