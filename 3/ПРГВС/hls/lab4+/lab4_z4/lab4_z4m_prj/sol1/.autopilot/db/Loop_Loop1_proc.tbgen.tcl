...
set C_modelArgList {
	...
	{ temp2 int 32 regular {array 16384 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_in", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "temp2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ temp2_address0 sc_out sc_lv 14 signal 4 } 
	{ temp2_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp2_we0 sc_out sc_logic 1 signal 4 } 
	{ temp2_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "temp2", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "temp2", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	temp2 { ap_memory {  { temp2_address0 mem_address 1 14 }  { temp2_ce0 mem_ce 1 1 }  { temp2_we0 mem_we 1 1 }  { temp2_d0 mem_din 1 32 } } }
}
