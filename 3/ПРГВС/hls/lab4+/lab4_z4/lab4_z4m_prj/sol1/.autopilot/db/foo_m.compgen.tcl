...
set ID 16
set hasByteEnable 0
set MemName foo_m_temp1_memcore
...
set InstName tmp1_loc_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 19
set FifoName fifo_w32_d2_A
set InstName tmp2_loc_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename scale \
    op interface \
    ports { scale_address0 { O 2 vector } scale_ce0 { O 1 bit } scale_d0 { O 32 vector } scale_q0 { I 32 vector } scale_we0 { O 1 bit } scale_address1 { O 2 vector } scale_ce1 { O 1 bit } scale_d1 { O 32 vector } scale_q1 { I 32 vector } scale_we1 { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_out \
    op interface \
    ports { data_out_address0 { O 14 vector } data_out_ce0 { O 1 bit } data_out_d0 { O 32 vector } data_out_q0 { I 32 vector } data_out_we0 { O 1 bit } data_out_address1 { O 14 vector } data_out_ce1 { O 1 bit } data_out_d1 { O 32 vector } data_out_q1 { I 32 vector } data_out_we1 { O 1 bit } } \
} "
} else {
